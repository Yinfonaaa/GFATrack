...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='gfatrack', help='Name of tracking method.')
    #parser.add_argument('--tracker_param', type=str, default='vitb_256_mae_ce_32x4_ep300', help='Name of config file.')
    parser.add_argument('--tracker_param', type=str, default='vitb_256_mae_ce_32x4_got10k_ep100', help='Name of config file.')
