...
cfg.MODEL.DECODER.TYPE = "vit_base_patch16_224"
cfg.MODEL.DECODER.EMBEDDIM = 768
cfg.MODEL.DECODER.DEPTH = 6
cfg.MODEL.DECODER.NUMHEADS = 12
cfg.MODEL.DECODER.MLPRATIO = 4


# MODEL.FinalBACKBONE
cfg.MODEL.FinalBACKBONE = edict()
cfg.MODEL.FinalBACKBONE.TYPE = "vit_base_patch16_224_ce"
cfg.MODEL.FinalBACKBONE.STRIDE = 16
cfg.MODEL.FinalBACKBONE.MID_PE = False
cfg.MODEL.FinalBACKBONE.SEP_SEG = False
cfg.MODEL.FinalBACKBONE.CAT_MODE = 'direct'
cfg.MODEL.FinalBACKBONE.MERGE_LAYER = 0
cfg.MODEL.FinalBACKBONE.ADD_CLS_TOKEN = False
cfg.MODEL.FinalBACKBONE.CLS_TOKEN_USE_MODE = 'ignore'
cfg.MODEL.BACKBONE.EMBEDDIM=768
cfg.MODEL.FinalBACKBONE.CE_LOC = []
cfg.MODEL.FinalBACKBONE.CE_KEEP_RATIO = []
cfg.MODEL.FinalBACKBONE.CE_TEMPLATE_RANGE = 'ALL'  # choose between ALL, CTR_POINT, CTR_REC, GT_BOX

# MODEL.SELFBACKBONE
cfg.MODEL.SELFBACKBONE = edict()
# cfg.MODEL.SELFBACKBONE.TYPE = "vit_base_patch16_224"
cfg.MODEL.SELFBACKBONE.TYPE = "vit_base_patch16_224_ce"
cfg.MODEL.SELFBACKBONE.STRIDE = 16
cfg.MODEL.SELFBACKBONE.MID_PE = False
cfg.MODEL.SELFBACKBONE.SEP_SEG = False
cfg.MODEL.SELFBACKBONE.CAT_MODE = 'direct'
cfg.MODEL.SELFBACKBONE.MERGE_LAYER = 0
cfg.MODEL.SELFBACKBONE.ADD_CLS_TOKEN = False
cfg.MODEL.SELFBACKBONE.CLS_TOKEN_USE_MODE = 'ignore'

cfg.MODEL.SELFBACKBONE.CE_LOC = []
cfg.MODEL.SELFBACKBONE.CE_KEEP_RATIO = []
cfg.MODEL.SELFBACKBONE.CE_TEMPLATE_RANGE = 'ALL'  # choose between ALL, CTR_POINT, CTR_REC, GT_BOX
...
# DATA.TEMPLATE_GT
cfg.DATA.TEMPLATE_GT = edict()
cfg.DATA.TEMPLATE_GT.NUMBER = 1
cfg.DATA.TEMPLATE_GT.SIZE = 128
cfg.DATA.TEMPLATE_GT.FACTOR = 2.0
cfg.DATA.TEMPLATE_GT.CENTER_JITTER = 0
cfg.DATA.TEMPLATE_GT.SCALE_JITTER = 0


# TEST
cfg.TEST = edict()
cfg.TEST.TEMPLATE_GT_FACTOR = 2.0
cfg.TEST.TEMPLATE_GT_SIZE = 128
...
def gen_config(config_file):
    ...
    with open(config_file, 'w') as f:
        yaml.dump(cfg_dict, f, default_flow_style=False)  #将yaml文件一次性全部写入你创建的文件。
